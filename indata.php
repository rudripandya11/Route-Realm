...
try {
    ...
    //Content
    $query = "INSERT INTO `inquiry`(`name`, `email`, `phone`) VALUES ('$name','$email','$phone')";
    $mail->isHTML(true); // Set email format to HTML    
    $mail->Subject = ' Information on Inquiry from Route Realm!';
    $mail->Body = "Dear $name,We got your inquiry our team will shortly contact you...!! Also Great news! Your subscription to  is now active, unlocking exclusive updates tailored just for you!. Here's what's in store: Stay tuned for valuable insights to make your tour and travel elegantly decorated! Warm regards, Route Realm Team.";
