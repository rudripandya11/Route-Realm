...
<section class="pageTitle bg-aboutus bg3A3A3C">
	<h1>Saurashtra Darshan  <span>with SOU</span></h1>
	<ul id="breadcrumb">
		<li><a href="home.php"><i class="fa fa-home"></i> Home</a></li>
		<li><a href="gujarat-travel-packages.php">Packages</a></li>
		<li>Saurashtra Darshan with SOU</li>
	</ul>
</section>
<section class="site-content bg-skyline">
	<div class="container">		
		<div class="content-with-sidebar">
			<h2 class="wow fadeInUp mb10">Ahmedabad - Dwarka -  Somnath - Diu - Vadodara - Ahmedabad  </h2>
			<h3 class="wow fadeInUp m0"><img src="images/touricon.png" alt="" width="34" /> 6N/7D Tour  Package</h3>
			<p class="text-justify wow fadeInUp">Come and experience rich spiritual journey of Gujarat along with beaches and Birth place of Shri Mahatma Gandhi. Explore new destination Statue of unity along with Saurashtra tour packages.  </p>
				...
				<div class="container container--lg cd-timeline__container">
					<div class="cd-timeline__block">
						...
						<div class="cd-timeline__content text-component">
							<h2>Day 1</h2>
							<ul class="fa-ul">
								<li><i class="fa-li fa fa-check-square-o"></i>Pick Up From Ahmadabad Airport/Railway Station</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Proceed For Dwarka</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Check In Hotel in Dwarka</li>
								<li><i class="fa-li fa fa-check-square-o"></i>If Possible Depend on time Darshan at Dwarkadhis Temple</li>
					...
					<div class="cd-timeline__block">
						...
						<div class="cd-timeline__content text-component">
							...
							<ul class="fa-ul">							
								...
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Nageshvar Jyotiling</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Rukmani Temple</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Shivrajpur Beach</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Night Stay Hotel in Dwarka</li>
							</ul>
							<div class="flex flex--space-between flex--center-y">
								<span class="cd-timeline__date"><img src="images/package-th-nageshwar-jyotirling.jpg" alt="" /></span>						
							</div>							
					...
					<div class="cd-timeline__block">
						...
						<div class="cd-timeline__content text-component">
							...
							<ul class="fa-ul">								
								...
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Porbandar Gandhi Ashram and Sudama Temple  </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Check In Hotel in Somnath </li>
					...
					<div class="cd-timeline__block">
						...
						<div class="cd-timeline__content text-component">
							...
							<ul class="fa-ul">
								<li><i class="fa-li fa fa-check-square-o"></i>Take Breakfast and Check Out from Hotel</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Proceed for Diu </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Diu Fort And Gangeshwar Mahadev Temple </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Check In Resort in Diu </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Evening Time Enjoy Beautiful Nagova Beach</li>
								
								<li><i class="fa-li fa fa-check-square-o"></i>Night Stay Hotel in Diu</li>
							</ul>
							<div class="flex flex--space-between flex--center-y">
								<span class="cd-timeline__date"><img src="images/package-th-tulsi-shyam.jpg" alt="" /></span>						
							</div>
						</div> <!-- cd-timeline__content -->
					</div> <!-- cd-timeline__block -->
					<div class="cd-timeline__block">
						...
						<div class="cd-timeline__content text-component">
							<h2>Day 5</h2>
							<ul class="fa-ul">
								<li><i class="fa-li fa fa-check-square-o"></i>Take Breakfast And Check Out From Resort </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Tulshi Shyam Temple </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Sarangpur Hanumanji Temple</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Proceed for Vadodara</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Night Stay Hotel in Vadodara</li>
							</ul>
							<div class="flex flex--space-between flex--center-y">
								<span class="cd-timeline__date"><img src="images/package-th-statue-of-unity.jpg" alt="" /></span>						
							</div>
						</div> <!-- cd-timeline__content -->
					</div> <!-- cd-timeline__block -->
					<div class="cd-timeline__block">
						...
						<div class="cd-timeline__content text-component">
							<h2>Day 6</h2>
							<ul class="fa-ul">
								<li><i class="fa-li fa fa-check-square-o"></i>Breakfast at the Dining Area </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Proceed For Kevadiya</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Statue of Unity</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Catucs Garden </li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Flower of Vally </li>
							...
							<div class="flex flex--space-between flex--center-y">
								<span class="cd-timeline__date"><img src="images/place-adalaj-stepwell.jpg" alt="" /></span>						
							</div>
						</div> <!-- cd-timeline__content -->
					</div> <!-- cd-timeline__block -->
					<div class="cd-timeline__block">
						...
						<div class="cd-timeline__content text-component">
							...
							<ul class="fa-ul">
								...
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Adalaj Stepwell</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Visit Kankariya Lake</li>
								<li><i class="fa-li fa fa-check-square-o"></i>Drop at Railway Station/Airport</li>
			...
			<div class="flexForm">
				...
				<div class="col">
					...
					<input id="phone" name="phone" type="tel" minlength="10" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
																					...
																					<input type="hidden" id="inquiryfor" name="inquiryfor" value="Saurashtra Darshan with SOU - 6N/7D">
