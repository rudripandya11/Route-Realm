...
<html>
	...
	<body>
		...
		<form name="form" id="registration" action="" method="POST">
			<table id="tbl" align="center" width="500px" style="margin-top:50px;">
				<tr>
				...
				<tr>
					<td>Phone number:</td>
					<td><input type="mobile" name="phone_num" id="pNum" placeholder="Phone number" /></td>
				</tr>
				...
				<tr>
					...
					<td>
						<select name="country" id="country">
							<option value="-1" selected disabled default>Country</option>
